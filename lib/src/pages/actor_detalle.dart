...
class ActorDetalle extends StatelessWidget {
  ...
  Widget _getDataActor(Actor actor) {
    final actorprovider = new ActoresProvider();

    return FutureBuilder(
      future: actorprovider.getBio(actor.id),
          ...
          Flexible(
            child: Column(
              ...
              children: <Widget>[
                ...
                Row(
                  children: <Widget>[Icon(Icons.star_border), Text(actor.rating.toString(), style: Theme.of(context).textTheme.bodyText1)],
                )
              ],
            ),
          )
  ...
  // Widget _descripcion(Actor pelicula) {
  //   return Container(
